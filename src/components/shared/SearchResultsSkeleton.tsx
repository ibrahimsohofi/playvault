      ...
      {isFiltering && (
        ...
        >
          {Array.from({ length: 3 }, (_, index) => (
            <div key={`filter-tag-${index}`} className="flex items-center gap-2">
              <ShimmerSkeleton
          ...
          >
            ...
            <div className="space-y-2">
              {Array.from({ length: 3 }, (_, subIndex) => (
                <div key={`filter-option-${index}-${subIndex}`} className="flex items-center gap-3">
