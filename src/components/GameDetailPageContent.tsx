...
export function GameDetailPageContent() {
  ...
  const handleDownloadClick = async () => {
    ...
    try {
      ...
      if (vpnResult.isVPN) {
        console.log('VPN detected during download - showing dialog and stopping process');
        setVerifying(false);
        setHasStartedVerification(false);
      ...
      if (adBlockerResult) {
        console.log('Ad blocker detected during download - showing dialog and stopping process');
        setVerifying(false);
        setHasStartedVerification(false);
      ...
      // All checks passed - verification complete, show locker
      console.log('All security checks passed - verification complete');
      setVerifying(false);
    } catch (error) {
