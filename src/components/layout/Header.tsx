    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      ...
      <div className="container-custom flex items-center justify-between h-16">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <img src="/logo.svg" alt="PlayVault Logo" className="h-10 w-auto rounded-none drop-shadow-[0_0_12px_#00f7ff88] transition-transform group-hover:scale-105" />
        </Link>
            ...
            <SheetContent side="right" className="border-l-[#00f7ff]/20" showCloseButton={true}>
              <div className="flex flex-col h-full">
                <div className="flex items-center mb-6">
                  <img src="/logo.svg" alt="PlayVault Logo" className="h-10 w-auto rounded-none drop-shadow-[0_0_12px_#00f7ff88]" />
                </div>
          ...
          <div className="mt-4 space-y-8">
              ...
              <div className="grid grid-cols-3 gap-2 mt-4">
                <div className="bg-background/50 rounded p-2 text-center">
                  <div className="flex justify-center mb-1">
                    <img src="/logo.svg" alt="PlayVault Logo" className="h-5 w-5 rounded-none drop-shadow-[0_0_12px_#00f7ff88]" />
                  </div>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3 flex items-center">
                <img src="/logo.svg" alt="PlayVault Logo" className="h-6 w-6 mr-2 rounded-none drop-shadow-[0_0_12px_#00f7ff88]" />
                My Games
              </h3>
